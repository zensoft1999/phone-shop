 ...
 * @author ASUS-PC
 */
public class AddItemsToCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (cart == null) {
                cart = new CartObject();
                LoginDTO user = (LoginDTO) session.getAttribute("LOGIN_USER");
            ...
            log ("Error at AddItemsToCartController: " + e.toString());
        } finally {
